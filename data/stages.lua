...
experienceStages = {
    ...
    { minlevel = 1401, multiplier = 1.2 }, -- Nível 1400+ conforme solicitado
}
...
skillsStages = {
    ...
    { minlevel = 121, multiplier = 2 }, -- 121 até 300+ conforme solicitado
}
...
magicLevelStages = {
    ...
    { minlevel = 131, multiplier = 2 }, -- 131 até 300+ conforme solicitado
}